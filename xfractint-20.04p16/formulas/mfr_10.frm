...
;RP2 Left: 5 Digits_Channel:1_main 2_outside 3_inside1 4_inside2 5_inside3
; Frms: 0_off 1_Sec 2_Mand(2) 3_Bees 4_Jul 5_Mmod 6_Phoen 7_Newt 8_Spid
; Right: 2 Digits_MMods_Number of sides 2 Dig_Phoenix 2 Dig_Spider
; 1 Dig_TransReset_main :0_no 1_dblmand 2_Iter-res 3_both +5_warp
; 4 Dig_TransReset_Ch2-5:0_no 1_z-reset 2_Iter-res 3_both +5_warp
;IP2 Left: 5 Digits_Bailout Number for Channels 1 to 5
; Right: Variab: 4 Digits_Mand/Jul(2 var) 2 Digits_Secant 4 Digits_Bees
;RP3 Left: 2 Digits_Newtonvariable 4 Digits_Colour1
; Right: 5 Digits_Colour2 5 Digits_Colour3
;IP3 Left: Main: 5 Digits_Warp-factor (fn1 is used)
; Right: 5 Digits_Colour4 6 Digits_Colour5
;RP4 Left: Outside: 5 Digits_Warp-factor (fn2 is used)
; Right: Outside: 4 Dig+1 fractaldig_bord-out 4 Dig+1 fractaldig_bord-in
;IP4 Left: Inside1_Maxiter
; Right: Inside1_Transition: 1_maxit 2_bordout 3_bordin +5_maxit+bord
; 5 Digits_Warp-factor (fn2 used) 4 Dig+1 fractaldig_border1
;RP5 Left: Inside2_Maxiter
; Right: Inside2_Transition: 1_maxit 2_bordout 3_bordin +5_maxit+bord
; 5 Digits_Warp-factor (fn3 used) 4 Dig+1 fractaldig_border2
;IP5 Left: Inside3_Maxiter
; Right: Inside3_Transition: 1_maxit 2_bordout 3_bordin +5_maxit+bord
; 5 Digits_Warp-factor (fn4 used) 4 Dig+1 fractaldig_border3
; Altnat: Left: 1_Lake effect enabled (Inside3 disabled)
; Right: 2 Digit_Frequency 2 Digit_Waterlevel 2 Digit_Amplitude
;
le=0
z=pixel
da=real(p2)
